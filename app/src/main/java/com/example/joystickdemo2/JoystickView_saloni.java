...
public class JoystickView_saloni extends View implements Runnable{
    ...
    */
     ...
     */
    public JoystickView_saloni(Context context) {
        this(context, null);
    }


    public JoystickView_saloni(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs);
    }
     ...
     */
    public JoystickView_saloni(Context context, AttributeSet attrs) {
        super(context, attrs);
